...
RUN_NAME="${RUN_NAME:-sdxl_cloud_teacher_watch46_v5_freeprompt}"
PROMPTS="${PROMPTS:-configs/sdxl_tiny_teacher_prompts_v5_watch_freeprompt.json}"
LIMIT="${LIMIT:-0}"
...
python3 tools/build_watch_v5_prompt_config.py --out "$PROMPTS"
