...
RUN_NAME="${RUN_NAME:-sdxl_cloud_teacher_watch75_v6_freeprompt}"
PROMPTS="${PROMPTS:-configs/sdxl_tiny_teacher_prompts_v6_watch_freeprompt.json}"
LIMIT="${LIMIT:-0}"
...
MAX_BORDER_EDGE_DENSITY="${MAX_BORDER_EDGE_DENSITY:-0.35}"
...
python3 tools/build_watch_v6_prompt_config.py --out "$PROMPTS"
