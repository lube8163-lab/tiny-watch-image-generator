...
RUN_NAME="${RUN_NAME:-sdxl_cloud_teacher_watch46_v3}"
PROMPTS="${PROMPTS:-configs/sdxl_tiny_teacher_prompts_v3_watch.json}"
LIMIT="${LIMIT:-0}"
VARIANTS_PER_PROMPT="${VARIANTS_PER_PROMPT:-12}"
SEEDS="${SEEDS:-0,1,2,5}"
STEPS="${STEPS:-20}"
WIDTH="${WIDTH:-768}"
HEIGHT="${HEIGHT:-768}"
...
MAX_BORDER_EDGE_DENSITY="${MAX_BORDER_EDGE_DENSITY:-0.45}"
