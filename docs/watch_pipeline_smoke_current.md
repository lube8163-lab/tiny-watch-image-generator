...
The app target should bundle the streamed 16-part 128px LCM UNet, the 128px VAE
decoder, and the transient text encoder assets:

- `lcm_unet_16x16_6bit_16p_part1.mlmodelc` ... `lcm_unet_16x16_6bit_16p_part16.mlmodelc`
...
2. Leave the default prompt as `cat mascot`, tap Generate, and confirm it
   ...
   `lcm decoder: output ... shape=[1, 3, 128, 128]`,
   `preview: Sharp x2 128x128->256x256`, and `done: total=...`.
